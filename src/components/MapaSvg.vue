...
const setUf = (uf, event) => {
  emit('update:modelValue', uf);
  Object.entries(document.querySelectorAll('a.active')).map(e => e[1].classList.remove('active'));
...
<template>
    <svg
      ...
      x="0px"
      y="0px"
      class="max-w-md max-h-[460px]"
      viewBox="0 0 450 460"
      enable-background="new 0 0 450 460"
      xml:space="preserve"
    >
      <g>
        <a xlink:href="#tocantins" @click.prevent="setUf('TO', $event)">
        ...
        <a xlink:href="#bahia" @click.prevent="setUf('BA', $event)">
          <title>Bahia</title>
          <path
            stroke="#FFFFFF"
            stroke-width="1.0404"
        ...
        <a xlink:href="#sergipe" @click.prevent="setUf('SE', $event)">
          <title>Sergipe</title>
          <path
            stroke="#FFFFFF"
            stroke-width="1.0404"
        ...
        <a xlink:href="#pernambuco" @click.prevent="setUf('PE', $event)">
        ...
        <a xlink:href="#alagoas" @click.prevent="setUf('AL', $event)">
          <title>Alagoas</title>
          <path
            stroke="#FFFFFF"
            stroke-width="1.0404"
        ...
        <a xlink:href="#riograndedonorte" @click.prevent="setUf('RN', $event)">
        ...
        <a xlink:href="#ceara" @click.prevent="setUf('CE', $event)">
          <title>Ceará</title>
          <path
            stroke="#FFFFFF"
            stroke-width="1.0404"
        ...
        <a xlink:href="#piaui" @click.prevent="setUf('PI', $event)">
          <title>Piauí</title>
          <path
            stroke="#FFFFFF"
            stroke-width="1.0404"
        ...
        <a xlink:href="#maranhao" @click.prevent="setUf('MA', $event)">
        ...
        <a xlink:href="#amapa" @click.prevent="setUf('AP', $event)">
          <title>Amapá</title>
          <path
            stroke="#FFFFFF"
            stroke-width="1.0404"
        ...
        <a xlink:href="#para" @click.prevent="setUf('PA', $event)">
          <title>Pará</title>
          <path
            stroke="#FFFFFF"
            stroke-width="1.0404"
        ...
        <a xlink:href="#roraima" @click.prevent="setUf('RR', $event)">
          <title>Roraima</title>
          <path
            stroke="#FFFFFF"
            stroke-width="1.0404"
        ...
        <a xlink:href="#amazonas" @click.prevent="setUf('AM', $event)">
        ...
        <a xlink:href="#acre" @click.prevent="setUf('AC', $event)">
          <title>Acre</title>
          <path
            stroke="#FFFFFF"
            stroke-width="1.0404"
        ...
        <a xlink:href="#rondonia" @click.prevent="setUf('RO', $event)">
        ...
        <a xlink:href="#matogrosso" @click.prevent="setUf('MT', $event)">
        ...
        <a xlink:href="#matogrossodosul" @click.prevent="setUf('MS', $event)">
        ...
        <a xlink:href="#goias" @click.prevent="setUf('GO', $event)">
          <title>Goiás</title>
          <path
            stroke="#FFFFFF"
            stroke-width="1.0404"
        ...
        <a xlink:href="#parana" @click.prevent="setUf('PR', $event)">
          <title>Paraná</title>
          <path
            stroke="#FFFFFF"
            stroke-width="1.0404"
        ...
        <a xlink:href="#santacatarina" @click.prevent="setUf('SC', $event)">
        ...
        <a xlink:href="#riograndedosul" @click.prevent="setUf('RS', $event)">
        ...
        <a xlink:href="#saopaulo" @click.prevent="setUf('SP', $event)">
        ...
        <a xlink:href="#minasgerais" @click.prevent="setUf('MG', $event)">
        ...
        <a xlink:href="#riodejaneiro" @click.prevent="setUf('RJ', $event)">
        ...
        <a xlink:href="#espiritosanto" @click.prevent="setUf('ES', $event)">
        ...
        <a xlink:href="#distritofederal" @click.prevent="setUf('DF', $event)">
        ...
        <a xlink:href="#paraiba" @click.prevent="setUf('PB', $event)">
          <title>Paraíba</title>
          <path
            stroke="#FFFFFF"
            stroke-width="1.0404"
